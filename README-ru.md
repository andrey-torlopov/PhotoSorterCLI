<div align="center">
  ...
  <p>
    <strong>Интерактивная Swift-утилита, которая упорядочивает фото- и видеоколлекции на macOS.</strong>
  </p>
  
  <p>
    <a href="#-какую-проблему-решаем">Проблема</a> •
    <a href="#-безопасность-превыше-всего">Безопасность</a> •
